...
(async function(){
  const tok=sessionStorage.getItem('aura_token');
...
async function verify(){
  ...
  try{
    ...
    const d=await r.json();
    if(d.ok){ sessionStorage.setItem('aura_token',d.token); localStorage.removeItem('aura_token'); localStorage.setItem('aura_tenant',d.tenant_id); msg('Acceso correcto','ok'); location.href='/dashboard?t='+d.tenant_id; }
